...
const qaData = [
  ...
  },
  {
    ...
    a: "本工具百分位計算採用「精密分段線性內插法」。不同工具即便數據同樣參考國健署標準，若計算邏輯不同，仍會產生微小落差：\n\n" +
       ...
       "● 早產兒矯正年齡：\n" +
       "僅在矯正後 3 歲以內的早產兒做年齡校正（符合台灣兒科醫學會共識）；超過 3 歲後改以實足年齡對照曲線。\n\n" +
       "● 遺傳身高採 Tanner 公式：\n" +
       "「父母身高推估成人身高」僅是族群統計平均期望值，個體遺傳變異很大，實際可差距 ±8cm 以上。不宜單以此結果判定孩子未來身高必然如何。\n\n" +
       "● 骨齡預估成人身高採 Bayley-Pinneau 法：\n" +
       "此法原始樣本以歐美族群為主，對東亞兒少可能有系統性偏差；且骨齡判讀本身因放射科醫師與採用方法（GP、TW3）不同會有差異，請務必以實際骨齡報告來源的判讀為主。\n\n" +
       "● 青春期分級：\n" +
       "若有輸入 Tanner 期數，以 Tanner 為主；若未輸入，僅能以年齡 + 身高百分位「粗略推估」，屬於初步篩選，無法取代門診理學檢查與第二性徵評估。\n\n" +
       "● 非醫療診斷工具：\n" +
