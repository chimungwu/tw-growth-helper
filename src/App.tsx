...
const qaData = [
  ...
  },
  {
    ...
    a: "為了避免誤讀，本工具能做與不能做的事，先講清楚：\n\n" +
       ...
       "● 遺傳身高（Tanner 公式）\n" +
       "「父母身高推估孩子成人身高」只是族群統計平均期望值，個體遺傳變異很大，實際差距常可達 ±8 cm 以上。本工具使用男 ±7.5 cm、女 ±6 cm 作為「符合遺傳預期」區間（比臨床教科書 ±8.5 cm 更嚴格），目的是早一步提醒、不是宣告結果。\n\n" +
  ...
  },
  {
    ...
    a: "這兩個是評估孩子未來身高的兩條獨立軸線，各看不同面向：\n\n" +
       ...
       "臨床教科書常用的是 ±8.5 cm（約 ±2 SD），本工具採用更嚴格的區間是為了早一步提醒；實務上多數孩子最終身高會落在 TH ± 8–10 cm 內。\n\n" +
  ...
  // ─── C. 家長行動指南 ────────────────────────
  {
    ...
    a: "身高百分位看的是「位置」，年生長速度（Growth Velocity）看的是「動能」。位置可能因遺傳天生偏矮、但動能正常，這就不算異常；反之，位置正常但動能突然下降，才是該警覺的訊號。\n\n" +
       ...
       "阿銘醫師提醒：比起單次測量，更建議每 3–6 個月量一次身高(固定時間、固定量尺、盡量同一人操作),把資料記錄下來觀察「趨勢」。單次偏離多半是測量誤差，趨勢偏離才是真訊號。"
  },
  {
  ...
  {
    q: "看到系統跳出偏離提醒，家長該怎麼做？",
    a: "看到提醒請先別慌。數據偏離並不直接代表疾病，而是提醒我們該關注孩子的「生長節奏」。建議依以下三步走：\n\n" +
       "【第一步：觀察趨勢】\n\n" +
       "單次偏離可能是測量誤差或短期波動。建議每 3–6 個月定期追蹤，觀察生長曲線是否持續偏離原有軌跡。若下一次測量又回到原本區間，多半不需擔心。\n\n" +
       "【第二步：檢視生活】\n\n" +
       "回想孩子近期的：\n" +
       ...
       "● 甲狀腺功能、生長激素、第二性徵檢查\n" +
       "● 中醫體質辨證與調理\n\n" +
       "阿銘醫師提醒：最忌諱看到提醒就開始「自己查資料、自己亂補」。先穩住節奏、觀察趨勢、找專業幫忙，才能少走冤枉路。"
  },
  {
    q: "中醫在兒童生長發育中扮演什麼角色？",
    a: "中醫看兒童生長，不只看身高數字，更看全身臟腑氣血的平衡表現。介入重點在於「調和脾胃」與「補益腎氣」，特別針對以下情況有顯著幫助：\n\n" +
       ...
       "● 體質干擾\n" +
       "過敏性鼻炎、異位性皮膚炎、睡眠品質差、壓力大等都會影響生長激素分泌。中醫透過體質調理改善這些「成長阻力」，讓孩子長得更輕鬆。\n\n" +
       "● 轉骨時機\n" +
       "中醫講究「因材施教」，針對不同發育階段給予個人化轉骨方，而非盲目進補。透過客觀數據(身高百分位、骨齡、Tanner 期)監測，能精準掌握介入的黃金期。\n\n" +
       "阿銘醫師提醒：中、西醫並不衝突，合作更能全方位守護孩子。西醫擅長結構性評估與急性介入，中醫擅長整體調理與體質優化，兩者搭配使用，讓孩子長得穩、長得壯。"
  }
];
